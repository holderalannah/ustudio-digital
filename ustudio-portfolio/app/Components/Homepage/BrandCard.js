...
export default function BrandCard({ data = [], gap = '1rem' }) {
  ...
  return (
    <div className="w-full">
      ...
      <ul
        className="brand-card-list marquee__inner mb-10 lg:mb-0"
      ...
      >
        {items.map((card, index) => {
          ...
          return (
            ...
            >
              <div
                className={`brand-card bg-gray-50 rounded-4xl flex justify-center items-center min-w-36 min-h-36 w-[11.6vw] h-[11.6vw] shadow-xl ${isOdd(index) ? 'rotate-2' : '-rotate-3'}`}
              >
                <Link
                  target="_blank"
